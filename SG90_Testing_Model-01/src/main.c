 ...
 * @version     V1.0.0
 * @date        25-March-2020
 * @brief       Main program body of L.A.E.P.K. SG90/MG995 Testing model
 ******************************************************************************
 * @attention
 *
 * None
...
/* Private typedef */
/* Private define  */
#define LimPos_Straight (76)    // The ADC value limit of leg straight
#define LimPos_Bent     (3724)  // The ADC value limit of knee bent
...
int POTdir = 0; //0:Unlimited; 1:Lim-Straight; -1:Lim-Bent
 ...
 * @return
 */
void CommunicationEncoder(uint8_t   MotorNumber,
                          uint16_t  Angle,
                          int8_t    LimitState,
                          uint16_t  PWM_CCP,
                          uint8_t   Ready_Fault,
